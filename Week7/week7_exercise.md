...
$$
Can you see the difference between a regular orbit and a chaotic orbit?
...
7) "2+2=5"! Choose a different orbital resonance ratio from Fig. 9.16 for each group and run the simulations. Plot the surface section as in (5). Upload your $x$, $\dot{x}$ [here](https://docs.google.com/spreadsheets/d/15RUfNkGNQk1gt9__fYm0785cu7k5rjrya2pjnki3jEY/edit?usp=sharing). Let's make a big plot together!
